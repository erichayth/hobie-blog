...
const module = defineNuxtModule({
  ...
  async setup(options, nuxt) {
    ...
    addTemplate({
      ...
      getContents: () => options.minimal ? genExport(join(runtimeDir, "client"), ["createClient"]) : genExport("@sanity/client", [{ name: "default", as: "createClient" }])
    });
    ...
    nuxt.hook("nitro:config", (config) => {
      ...
      config.virtual["#sanity-client"] = options.minimal ? genExport(join(runtimeDir, "client"), ["createClient"]) : genExport("@sanity/client", [{ name: "default", as: "createClient" }]);
