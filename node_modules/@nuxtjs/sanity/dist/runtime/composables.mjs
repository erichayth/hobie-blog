...
export const useSanityQuery = (query, _params, _options = {}) => {
  ...
  return useAsyncData("sanity-" + objectHash(query + (params ? JSON.stringify(params) : "")), () => sanity.fetch(query, params), options);
};
export const useLazySanityQuery = (query, _params, _options = {}) => {
  ...
  return useLazyAsyncData("sanity-" + objectHash(query + (params ? JSON.stringify(params) : "")), () => sanity.fetch(query, params), options);
};
